...
public:
    ...
    struct Config {
        ...
        Game *game;
        std::vector<std::pair<std::shared_ptr<Entity>, int>> *obstacles;
        std::vector<std::vector<std::pair<std::shared_ptr<Entity>, int>>> *levelObstacles;
    };
    ...
    std::shared_ptr<GameStage> createStage();
