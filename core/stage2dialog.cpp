...
Stage2Dialog::Stage2Dialog(Game &game, std::shared_ptr<Stickman> stickman, std::shared_ptr<EntityFactory> factory, std::vector<std::pair<std::shared_ptr<Entity>, int>> obstacleLayout) :
