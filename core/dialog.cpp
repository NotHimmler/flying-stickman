...
Dialog::Dialog(Game &game, std::shared_ptr<Stickman> stickman, std::shared_ptr<EntityFactory> factory):
    game(game),
...
void Dialog::setStickman(std::shared_ptr<Stickman> stickman) {
...
void Dialog::addObstacle(std::shared_ptr<Entity> obstacle) {
